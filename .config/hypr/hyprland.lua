...
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd( "noctalia-shell kill" ))
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd( "noctalia-shell &" ))
...
-- Workspace Travel w/ Mousewheel
hl.bind(mainMod .. " + mouse_down", hl.dsp.focus({ workspace = "e+1" }))
hl.bind(mainMod .. " + mouse_up",   hl.dsp.focus({ workspace = "e-1" }))

-- Window Resizing w/ Mouse
...
-- Zen Rules
hl.window_rule({ match = { class = "zen-beta" }, no_blur = true })
